												...
												<form id="formId" class="form-horizontal" action="fileupload" method="post" enctype="multipart/form-data"> 
													<div class="form-group"> 
														...
														<div class="col-md-8">
															<div class="input-group">															
																<input id="fileId" type="text" class="form-control" placeholder="Upload File" disabled>												
													...
													<div class="form-group">									
														<div class="col-md-offset-2">
															<div>										
																<div class="col-md-2"><button id="fileuploadsubmit" type="button" class="btn btn-default">Submit</button></div>															  																									
																<div class="col-md-2 checkbox"><label><input type="checkbox" id="updateRecords" name="updateRecords" value="updateRecords"/>&nbsp;Update</label></div>
																<div class="col-md-5"><span id="loadingimage" style="display:none"><img class="col-sm-offset-2" alt="LngLogo" src="${pageContext.request.contextPath}/images/loading2.gif"/></span></div>
															</div>
															<!--<input type="submit"/>-->
													...
													<!-- <div>&nbsp;</div>-->													
													 <div class="form-group"> 
									  					<label id="displayMsg" for="inputPassword3" class="col-sm-offset-3 control-label" style="display:none"></label>									 	
									 				 </div>		
									 				 <input style="display:none" type="checkbox" id="dummy" name="dummy" value="dummy" checked>	<!-- This is added due to the checkbox it is not working in IE when file upload so... this dummy check box added -->										
												</form> 
