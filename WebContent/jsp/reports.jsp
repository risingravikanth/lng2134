...
<html>
	...
	<body class="cbp-spmenu-push">
		<div class="main-content">
				...
				<div class="main-page"><!-- main page starting -->
					<div class="forms"><!-- Forms div starting -->
										...
										<div class="form-body" data-example-id="simple-form-inline">
											<form class="form-inline" id="dataForm"  method="post"> 																		
											  	...
											  	<div class="form-group">
													...
													<div class="col-sm-8">
														<select name="sector" id="sectorList" class="form-control1">
						...
						<div class="row"> <!-- row two starting -->
							...
							<div class="table-responsive bs-example widget-shadow" style="display:none" id="reportTable">							
								<table id="reportTablepagination" class="table table-bordered">
									 <thead>
									  	<tr>
									  		 <th>#</th>
									  		 <th>Report Title</th>
			...
			<script src="${pageContext.request.contextPath}/js/reportsajax.js"></script>
