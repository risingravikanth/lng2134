				...
				<div class="main-page"><!-- main page starting -->
					<div class="forms"><!-- Forms div starting -->
								...
								<div class="form-two widget-shadow">
									...
									<div class="col-sm-offset-3">
										<div class="form-body" data-example-id="simple-form-inline">
											<form class="form-inline" id="userAuditForm"  method="post"> 
											    ...
											    <button id="userAuditSubmit" type="button" class="btn btn-default">Submit</button>
											    <div>&nbsp;</div>
											    <div class="form-group col-md-12 col-md-offset-2">
											    	 <label style="display:none" id="displayMsg"></label>
													<!--  <label style="display:none" id="noauditrecords">No Records for the Selected Period</label>
													 <label style="display:none" id="startDateReq">Start Date is Required</label>
													 <label style="display:none" id="endDateReq">End Date is Required</label>	-->												
											    </div>
						...
						<div class="row"> <!-- row two starting -->
							...
							<div class="table-responsive bs-example widget-shadow" style="display:none" id="userAuditTable">							
								<table  id="userAuditTablepagination" class="table">
									<thead>
										<tr>
											<th>S.NO</th>
											<th>User</th>
